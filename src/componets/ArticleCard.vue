<template>
  <div class="relative mb-1">
    ...
    <span class="absolute right-0 top-0 text-sm flex"
      ...
      />
      <SquarePen class="ml-6 w-5 h-5 cursor-pointer transition" @click="$emit('edit', article)" />
    </span>
...
<script setup>
import { Star, SquarePen } from 'lucide-vue-next'
import { formatDate } from '@/utils/date'
defineProps(['article'])
defineEmits(['edit', 'toggleFavorite'])
</script>
